...
public class HyconVersionPreferenceController extends BasePreferenceController {
    ...
    public CharSequence getSummary() {
        String hyconVersion = SystemProperties.get(PROPERTY_HYCON_VERSION,
                mContext.getString(R.string.unknown));
        String hyconReleasetype =  SystemProperties.get(ROM_RELEASETYPE_PROP,
                this.mContext.getString(R.string.unknown));
        String hyconCodename = SystemProperties.get(ROM_CODENAME_PROP,
                mContext.getString(R.string.unknown));
        if (!hyconVersion.isEmpty() && !hyconReleasetype.isEmpty())
            return hyconVersion + " | " + hyconCodename + " | " +  hyconReleasetype;
        else
            return mContext.getString(R.string.hycon_version_default);
    }
